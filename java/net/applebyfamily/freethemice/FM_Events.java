...
public class FM_Events {
    ...
    public void gameTick() {
        ...
        Point3d tmpPlayer = new Point3d((int) FinderMod.instance.thePlayer.posX, (int) FinderMod.instance.thePlayer.posY,
                (int) FinderMod.instance.thePlayer.posZ);
        ...
        if (Find == 0) {
            if (FinderMod.instance.myGuiHandeler._MyGui.searchName != null) {
                if (FinderMod.instance.myGuiHandeler._MyGui.searchName.equals("") == false) {
                    if (FinderMod.instance.myGuiHandeler._MyGui.searchName.equalsIgnoreCase("waypoints") == true
                            || FinderMod.instance.myGuiHandeler._MyGui.searchName.equalsIgnoreCase("waypoint") == true) {
                    ...
                    for (int x = 0; x < tmpTEL.size(); x++) {
                        ...
                        if (tmpTEL.get(x).toString().toLowerCase().contains(FinderMod.instance.myGuiHandeler._MyGui.searchName.toLowerCase())
                                == true) {
                            FM_Point3d tmp =
                                    new FM_Point3d(((Entity) tmpTEL.get(x)).posX, ((Entity) tmpTEL.get(x)).posY, ((Entity) tmpTEL.get(x)).posZ);
                    ...
                    for (int x = 0; x < tmpTEL.size(); x++) {
                        ...
                        if (tmpTEL.get(x).toString().toLowerCase().contains(FinderMod.instance.myGuiHandeler._MyGui.searchName.toLowerCase())
                                == true) {
                            FM_Point3d tmp = new FM_Point3d(((TileEntity) tmpTEL.get(x)).xCoord, ((TileEntity) tmpTEL.get(x)).yCoord,
                                    ((TileEntity) tmpTEL.get(x)).zCoord);
                            tmp.block = true;
                            this.tmpDrawersList.add(tmp);
                        }
                        ...
                        for (int x = -this.range; x < this.range + 1; x++) {
                            for (int y = 0; y < 256; y++) {
                                for (int z = -this.range; z < this.range + 1; z++) {
                                    if (theWorld.getBlock((int) FinderMod.instance.thePlayer.posX + x, y, (int) FinderMod.instance.thePlayer.posZ + z)
                                            .getUnlocalizedName().toString().toLowerCase()
                                            .contains(FinderMod.instance.myGuiHandeler._MyGui.searchName.toLowerCase()) == true) {
                                        FM_Point3d tmp = new FM_Point3d((int) FinderMod.instance.thePlayer.posX + x, y,
                                                (int) FinderMod.instance.thePlayer.posZ + z);
                ...
                for (int y = 0; y < 256; y++) {
                    for (int z = -this.range; z < this.range + 1; z++) {
                        ...
                        if (Block.getIdFromBlock(
                                theWorld.getBlock((int) FinderMod.instance.thePlayer.posX + x, y, (int) FinderMod.instance.thePlayer.posZ + z))
                                == Find) {
                            FM_Point3d tmp =
                                    new FM_Point3d((int) FinderMod.instance.thePlayer.posX + x, y, (int) FinderMod.instance.thePlayer.posZ + z);
                            if (tmp != null) {
                                tmp.block = true;
                                this.tmpDrawersList.add(tmp);
                            }
