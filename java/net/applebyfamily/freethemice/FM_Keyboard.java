...
public class FM_Keyboard {
    ...
    public void listener() {
        try {
            if (Keyboard.isKeyDown(FinderMod.instance.NumberforB[0]) == true && _iskeydown_B == false
                    && FinderMod.instance.myGuiHandeler._MyGui._visible == false && FinderMod.instance.MC.currentScreen == null) {
                _iskeydown_B = true;
                ...
                FinderMod.instance.thePlayer.openGui(FinderMod.instance, 0, FinderMod.instance.theWorld, (int) FinderMod.instance.thePlayer.posX,
                        (int) FinderMod.instance.thePlayer.posY, (int) FinderMod.instance.thePlayer.posZ);
            ...
            if (Keyboard.isKeyDown(FinderMod.instance.NumberforN[0]) == true && _iskeydown_N == false
                    && FinderMod.instance.myGuiHandeler._MyGui._visible == false && FinderMod.instance.MC.currentScreen == null) {
                _iskeydown_N = true;
                Point3d testTMP =
                        new Point3d(FinderMod.instance.thePlayer.posX, FinderMod.instance.thePlayer.posY, FinderMod.instance.thePlayer.posZ);
                ...
                FinderMod.instance.eventManager.Waypoints
                        .add(new FM_Point3d(FinderMod.instance.thePlayer.posX, FinderMod.instance.thePlayer.posY, FinderMod.instance.thePlayer.posZ));
